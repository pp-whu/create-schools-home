...
$(document).ready(function() {
  if (count_parents()==2||count_parents()==1) {
    ...
    // $('.current').parents('.has-sub').find('.s-icon').replaceWith('<i class="s-icon"><svg role="img" class="symbol" aria-hidden="true" focusable="false"><use xlink:href="' + template_path + '/img/icons.svg#minus"></use></svg></i>');
  }
});
...
$('#main-menu li.has-sub > a').on('click', function() {
  ...
  if (element.hasClass('open')) {
    ...
    $(this).children('.s-icon').replaceWith('<i class="s-icon"><svg role="img" class="symbol" aria-hidden="true" focusable="false"><use xlink:href="' + template_path + '/img/icons.svg#arrow-lefts"></use></svg></i>');
  ...
  $('#main-menu').find('.has-sub').not('.open').find('.s-icon').replaceWith('<i class="s-icon"><svg role="img" class="symbol" aria-hidden="true" focusable="false"><use xlink:href="' + template_path + '/img/icons.svg#arrow-left"></use></svg></i>');
});
